...
public class EdgarUtil2 {
    ...
    public static int generateTps(long count) {
        ...
        } else if(count > 30000 && count <= 45000) {
            return generateTpsSecondSpike(count-30000);
        } else if(count > 62500 && count <= 95000) {
            return generateTpsLastSpike(count-62500);
        } else {
            return 225;
        }
    }
    ...
    public static int generateTpsFirstSpike(long count) {
        if (count > 1000 && count <= 2000) {
            ...
            return EdgarUtil2.generateRandomTps();
            ...
            return handle1000Down(count, 15000);
            ...
            return handle1000Down(count, 18000);
            ...
            return handle1000Down(count, 21000);
